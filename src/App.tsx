...
const WHATSAPP_URL = `https://wa.me/${PHONE}?text=${encodeURIComponent("Hi Konkan Palace Lodge, I'd like to book a room.")}`;
  ...
  return (
    <div className="min-h-screen bg-cream text-ink overflow-x-hidden">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] glass-card-strong shadow-2xl shadow-black/5">
            ...
            <div className="relative z-10 px-8 md:px-14 py-14 md:py-20 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-base md:text-lg font-bold bg-white border-2 border-gold/30 text-ink hover:bg-gold/5 hover:-translate-y-1 transition-all duration-300">WhatsApp Us</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-12 gap-10 md:gap-8">
            <div className="md:col-span-5">
              ...
              <div className="flex gap-2">
                ...
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-xl bg-gradient-to-br from-ink/5 to-ink/10 flex items-center justify-center text-ink hover:text-white hover:bg-ink transition-all">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-[#25D366] text-white shadow-2xl shadow-black/20 flex items-center justify-center text-xl hover:scale-110 transition-transform" title="WhatsApp">
